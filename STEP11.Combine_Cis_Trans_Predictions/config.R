...
DATA_PATHS = list(
  # RNA-seq data
  rnaseq = list(
    testing = file.path(BASE_DIR, "rnaseq/gtex_rnaseq.RData")
  ),
  
  # Predictions directory
  predictions = list(
    base = file.path(BASE_DIR, "predictions/LIBD_training/GTeX.v9/"),
    combined = file.path(BASE_DIR, "predictions/LIBD_training/GTeX.v9/Combined")
  )
)
...
BRAIN_REGIONS = c("dlpfc","caudate","hippo","dACC","sACC","amygdala")
