...
site               = "your_training_genotype.bim" # GTeX.v9.phased.geno.maf.bfile.updated.EUR    CMC_EUR.IBD.geno0.02.hwe10e6.mind0.02.maf0.01.hg20  LIBD_TopMed.geno.maf.EUR.chr1_22.noindels.overlap.GTEX
...
## g1000 bim file
bim_g1000       = read.delim("./GRCh38/g1000_eur.pvar") ## from 1000G


print("start")
if(!file.exists(paste0("./STEP4.LDproxy_Testing_Geno/LD_output/",model,".", name_site, "_LDtable.RData"))){
  ...
  LD_chunk = mclapply(unique(LD$ID_A), function(x) {
    ...
    return(table.match)
  }, mc.cores = 10)  # Adjust this based on the number of cores available 
  ...
  save(LD, file = paste0("./STEP4.LDproxy_Testing_Geno/LD_output/",model,".", name_site, "_LDtable.RData"))
