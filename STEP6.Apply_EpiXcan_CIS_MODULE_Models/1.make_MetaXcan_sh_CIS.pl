...
my $main_path        = "./STEP2.Training_cis/output/database/"; 
...
foreach my $target (@targets) {
    ...
    foreach my $region (@regions) {
        ...
        foreach my $genotype_file (@genotype_files) {
            ...
            my $results_dir = "$results_path/CIS";
            ...
            print $script_fh "--model_db_path \$MAIN/${region}/CIS_${region}.db \\\n"; 
            ...
            print $script_fh "--prediction_output \$RESULTS/CIS/CIS_${region}_predicted.txt.gz \\\n";
            print $script_fh "--prediction_summary_output \$RESULTS/CIS/CIS_${region}_summary.txt.gz \\\n";
