#' EpiXcan Genotype Matching Script --> Output will be used in INGENE training --> imputed coexpression partners values
#' 
...
CONFIG    = list(
  ...
  database  = list(
    base_path = "./STEP2.Training_CIS/output_GTEx_EpiXcan/database/",
    suffix    = "EpiXcan_%s_testing_genotype_name"
  ),
  temp_files = list(
    directory        = "./temp/",
