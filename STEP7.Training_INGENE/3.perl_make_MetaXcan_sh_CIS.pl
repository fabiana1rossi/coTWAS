...
my $main_path        = "./STEP2.Training_CIS/output_GTEx/database/";
my $data_path        = "./genotype/CIS.matched.geno";
...
my @regions        = ("dlpfc","caudate","hippo","amygdala","acc");
...
foreach my $target (@targets) {
    ...
    foreach my $region (@regions) {
        ...
        foreach my $genotype_file (@genotype_files) {
            ...
            my $results_dir = "$results_path/${outdir}/${training_dataset_folder}/CIS";
            ...
            my $script_path = "${output_directory}/CIS_${region}_MetaXcan_script_${target}.sh";
            ...
            print $script_fh "--model_db_path \$MAIN/${region}/CIS_${region}_${training_dataset}.db \\\n";
            print $script_fh "--model_db_snp_key rsid \\\n";
            print $script_fh "--vcf_genotypes \$DATA/${genotype_file}_${region}_CIS.matched.vcf \\\n";
            print $script_fh "--vcf_mode genotyped \\\n";
            print $script_fh "--force_colon \\\n";
            print $script_fh "--prediction_output \$RESULTS/${outdir}/${training_dataset_folder}/CIS/CIS_${region}_${training_dataset}_predicted.txt.gz \\\n";
            print $script_fh "--prediction_summary_output \$RESULTS/${outdir}/${training_dataset_folder}/CIS/CIS_${region}_${training_dataset}__summary.txt.gz \\\n";
