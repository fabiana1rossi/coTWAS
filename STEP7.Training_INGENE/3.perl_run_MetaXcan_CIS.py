...
regions = ["acc","caudate","hippo","dlpfc","amygdala"] ## your regions here
...
for region in regions:
    ...
    files_sh = [file for file in os.listdir(directory) if "CIS_%s_MetaXcan_script_%s" % (region,dataset) in file]
